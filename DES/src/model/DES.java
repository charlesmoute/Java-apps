 ...
 *  <strong>NB</strong> Dire qu'une parametre tient sur x bits ceci revient a dire que sa representation binaire
...
public class DES {
	...
	public static void main(String[] arg) throws Exception{
		...
		String crypted = DES.encode(binary, key);
		...
		String discrypted = DES.decode(binaireValue, key);
