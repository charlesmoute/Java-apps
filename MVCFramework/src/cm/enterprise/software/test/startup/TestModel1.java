...
/**
 * Cette classe teste tout particulierement le controlleur du model 1.
 * Ce qui permettra de faire le test de tout les concepts naviguant autour
 * de ce model1.
 * @author Charles Moute
 * @version 1.0.1, 21/07/2010
 */
public class TestModel1 extends Application {

	ControllerOfModel1 controller;
	...
	/**
	 * Instancie une instance de test du model1
	 * @throws ProgramException
	 */
	public TestModel1() throws ProgramException{
		
		addResource(ResourceModel1.class);
		
		controller = new ControllerOfModel1(new Model1());
		/*
		 ...
		 */
		controller.installView(View1Model1.class,controller);
		controller.installView(View2Model1.class,controller);
		
		frame = new JFrame("Fenetre de control du model 1");
	...
	public void changeLanguage(String language){
		...
		view1.getContentPane().add((JPanel)controller.getContentOf(View1Model1.class));
		view1.repaint();
		view1.pack();
		
		if (view2.getContentPane().getComponentCount()>0) view2.getContentPane().remove(0);
		view2.getContentPane().add((JPanel)controller.getContentOf(View2Model1.class));
		view2.repaint();
		view2.pack();
	}
	...
	public void showView1(){
		view1.setVisible(true);
		controller.showView(View1Model1.class);
	}
	...
	public void hideView1(){
		view1.setVisible(true);
		controller.hideView(View1Model1.class);
	}
	...
	public void enableView1(){
		view1.setVisible(true);
		controller.enableView(View1Model1.class);
	}
	...
	public void disableView1(){	
		view1.setVisible(true);
		controller.disableView(View1Model1.class);
	}
	...
	public void validAction(){
		view1.setVisible(true);
		controller.getViewOfClass(View1Model1.class).validAction();
	}
	...
	public void showView2(){
		view2.setVisible(true);
		controller.showView(View2Model1.class);
	}
	...
	public void hideView2(){
		view2.setVisible(true);
		controller.hideView(View2Model1.class);
	}
	...
	public void enableView2(){
		view2.setVisible(true);
		controller.enableView(View2Model1.class);
	}
	...
	public void disableView2(){
		view2.setVisible(true);
		controller.disableView(View2Model1.class);
	}
	
	
	public static void main(String[] args) throws ProgramException {

		TestModel1 soft = new TestModel1();
		soft.test();
	}
